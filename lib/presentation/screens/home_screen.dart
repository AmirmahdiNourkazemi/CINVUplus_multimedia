...
class _HomeScreenState extends State<HomeScreen>
  ...
  final GlobalKey _drawerIconKey = GlobalKey();
  final GlobalKey _themeButtonKey = GlobalKey();
  final GlobalKey _defaultKey = GlobalKey();
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ShowCaseWidget.of(context).startShowCase([
        if (!_sharedPrefs.isShowCase(LIST_ITEM_KEY)) _listItemKey,
        if (!_sharedPrefs.isShowCase(MENU_OPTIONS_KEY)) _drawerIconKey,
        if (!_sharedPrefs.isShowCase(THEME_BUTTON_KEY)) _themeButtonKey,
        _defaultKey
      ]);
    });
    super.initState();
  ...
  Widget _buildHomeBody(DarkThemeProvider themeProvider) {
    if (_sharedPrefs.isShowCase(MENU_OPTIONS_KEY) &&
        !_sharedPrefs.isShowCase(THEME_BUTTON_KEY)) {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Showcase(
                        key: _themeButtonKey,
                        description: 'Tap to change app theme.',
                        disableDefaultTargetGestures: true,
                        onBarrierClick: () {
                          _sharedPrefs.setShowCase(THEME_BUTTON_KEY, true);
                        },
                        child: IconButton(
            ...
            appBar: AppBar(
              ...
              leading: Padding(
                ...
                child: Showcase(
                  ...
                  disableDefaultTargetGestures: true,
                  onBarrierClick: () {
                    _sharedPrefs.setShowCase(MENU_OPTIONS_KEY, true);
                    _advancedDrawerController.showDrawer();
                  },
                  child: IconButton(
                ...
                children: List.generate(
                  ...
                  (int index) {
                    return AnimationConfiguration.staggeredGrid(
                      ...
                      columnCount: 2,
                      child: (index == 0 &&
                              !_sharedPrefs.isShowCase(LIST_ITEM_KEY))
                          ? Showcase(
                              key: _listItemKey,
                              description:
                                  'Tap to see feature details, Long click to see features description.',
                              disableDefaultTargetGestures: true,
                              onBarrierClick: () => {
                                _sharedPrefs.setShowCase(LIST_ITEM_KEY, true)
                              },
